...
public class BufferedHashedRecordExchanger {

    private final HashedRecordChannel channel;
    ...
    public BufferedHashedRecordExchanger(HashedRecordChannel channel, Configuration configuration) {
        assert channel != null;
